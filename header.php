 ...
 * Purpose: This is the header included on each page for the Travel Experts Website.
...
<head>
    ...
    <!-- JAVASCRIPT -->
    <!--            -->
    <!--the script lines below conects to jquery library which allows the functionality of this modal--->
