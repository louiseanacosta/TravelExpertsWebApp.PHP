...
<?php include_once 'menu.php' ?>
    ...
    <div>
        <table>
            <td class="paddingRight"><a href="products.php"><img src='img/egypt2.jpg'>Flights, Hotels, Cars and More</a>
            </td>
            <td class="paddingRight"><a href="packages.php"><img src='img/italy2.jpg'>All Inclusive Vacations and
                    More</a></td>
