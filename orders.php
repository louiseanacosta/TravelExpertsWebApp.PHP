    ...
    <h2 class="center" style="clear:left">Traveler Information</h4><br>
        <form action="">
            ...
            <div class="form-group">
                ...
                <label for="MiddleInitial">Middle Initial: </label><input type="text" name="MiddleInitial" maxlength="1"
                                                                          required>
                ...
                <button method="POST" type="button" name="button" class="btn btn-default btn-lg" style='float:right'>Add
                    Traveller
                </button>
                </a>
        ...
        <h2 class="center">Payment Information</h4><br>
            <form action="">
                ...
                <button type="button" class="btn btn-default btn-lg" style='float:right'>Submit Booking</button>
                </a>
            </form>
